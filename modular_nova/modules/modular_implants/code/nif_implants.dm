...
/obj/item/organ/cyberimp/brain/nif/standard
	...
	manufacturer_notes = "While countless manufacturers produce their own implementation of NIFs, open-source or not, Standard-Type models are the measure by which other NIF platforms are compared. These are the results of almost five years of improvements on older models of Frameworks, and are rather coveted due to being extremely difficult to 'homebrew.'"

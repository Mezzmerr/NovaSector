...
/datum/round_event/sandstorm/announce(fake)
	...
	priority_announce("A large wave of space dust is approaching from the [start_side_text] side of the station. \
		Impact is expected within the next two minutes. All employees are encouranged to assist in repairs and damage mitigation if possible.", "Collision Emergency Alert")
